...
async function loadSavedThreads() {
  ...
  // Cargar confesiones + conteo de comentarios + perfiles de autores en paralelo
...
function buildThreadRow(save, confession, commentCount, authorProfile) {
  ...
  // ── Fila media: texto + thumbnail lateral (igual al feed) ────
